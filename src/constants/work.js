export const workConstants = {
  quartermaster: {
    ...
    details: [
      ...
      "Wrote extendable code that provided fast and easy product changes",
      "Built effective organization-wide QA processess for product and tech.",
    ],
  },
  evenset: {
    id: 2,
  ...
  harvey: {
    ...
    details: [
      ...
      "Designed illustrations with Sketch",
      "Built with Create React Native App and Expo",
    ],
  },
}
